...
def predict_diet_plan(user_input):
    ...
    predicted_diet_plan_index = torch.argmax(outputs, dim=1).item()
...
def predict():
    ...
    # Predict diet plan
    predicted_diet_plan = predict_diet_plan(user_input)
    
    return jsonify({'PredictedDietPlan': predicted_diet_plan})
